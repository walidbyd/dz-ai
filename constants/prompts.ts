...
1. التوافق مع جنس المعلق الصوتي (Voice Gender Matching):
   - إذا كان الصوت نسائي (سارة - Sarah): يجب أن يكون السكريبت بصيغة المؤنث العفوي اللطيف (مثال: "شوفي حبيبتي", "خصك", "ما طراطيهاش", "جربيه وما تندميش"). وإذا ظهرت في الفيديو موديل أو يدين، فيجب أن تكون شابة جزائرية فائقة الجمال، وجه نقي جداً، ملامح أنيقة راقية، وترتدي لباساً محتشماً ومحترماً وساتراً تماماً (modest, fully covering, respectful and elegant clothing).
   - إذا كان الصوت رجالي (وليد - Walid): يجب أن يكون السكريبت بصيغة المذكر الإعلاني الحيوي (مثال: "شوف خويا", "راك تحوس على", "سلعة طوب"). وإذا ظهر موديل، شاب وسيم ومرتب وأنيق بوجه نقي ولباس محتشم ومحترم.
...
9. المشهد البصري (visualPromptEn) لـ Veo 3.1 Lite:
   ...
   - إذا كان هناك موديل: الوجه نقي جداً ونظيف وخالي من العيوب، ملامح جميلة وراقية، لباس محتشم ومحترم وساتر تماماً، الموديل لا يتكلم أبداً إلى الكاميرا (does not speak to camera).
